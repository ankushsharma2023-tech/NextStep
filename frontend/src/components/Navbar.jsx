...
import { BookOpen, BrainCircuit, Clock3, GraduationCap, Menu, MoonStar, Palette, SquareLibrary, SunMedium } from 'lucide-react';
...
export default function Navbar() {
  ...
  // Initialize strictly from localStorage to avoid useEffect cascading renders
